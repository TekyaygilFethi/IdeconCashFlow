...
{
    [DbContext(typeof(IdeconCashFlowDbContext))]
    partial class IdeconCashFlowDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("IdeconCashFlow.Data.POCO.AnaBaslik", b =>
                {
                    ...
                    b.HasIndex("TekliBaslikID")
                        .IsUnique()
                        .HasFilter("[TekliBaslikID] IS NOT NULL");

                    b.ToTable("AnaBasliklar");
                });
            ...
            modelBuilder.Entity("IdeconCashFlow.Data.POCO.Kalem", b =>
                {
                    ...
                    b.HasIndex("ParaBirimiKalemID")
                        .IsUnique()
                        .HasFilter("[ParaBirimiKalemID] IS NOT NULL");
            ...
            modelBuilder.Entity("IdeconCashFlow.Data.POCO.AnaBaslik", b =>
                {
                    b.HasOne("IdeconCashFlow.Data.POCO.TekliBaslik", "TekliBaslik")
                        .WithOne("AnaBaslik")
                        .HasForeignKey("IdeconCashFlow.Data.POCO.AnaBaslik", "TekliBaslikID")
                        .HasPrincipalKey("IdeconCashFlow.Data.POCO.TekliBaslik", "AnaBaslikID")
