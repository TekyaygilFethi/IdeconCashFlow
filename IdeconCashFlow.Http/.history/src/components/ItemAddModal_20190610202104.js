...
import { TextField, Select, Switch, Button ,SelectField,MenuItem,FormHelperText,InputLabel,FormControl} from "@material-ui/core/index";
            ...
            <>
                <div className="row mt-5">
                    ...
                    <div className="col-sm-push-2 col-sm-8">
                        <div className="card">
                            <FormFields onSubmit={this.handleSubmit} flowDirectionOptions={flowDirections} currencyOption={currencies} />  
                        </div>
                    </div>
                </div>
            </>
